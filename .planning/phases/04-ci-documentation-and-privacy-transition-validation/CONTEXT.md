...
- Manual browser evidence uses actual current Chrome and Edge availability and records limitations honestly.
...
5. Run Chrome and Edge smoke checks for popup, module load, generic capture, specialized enrichment, report safety, and CSP limitations.
